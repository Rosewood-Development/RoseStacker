...
import dev.rosewood.rosestacker.nms.v1_15_R1.entity.SoloEntitySpider;
import dev.rosewood.rosestacker.nms.v1_15_R1.object.CompactNBTImpl;
import dev.rosewood.rosestacker.nms.v1_15_R1.object.SpawnerTileWrapperImpl;
import dev.rosewood.rosestacker.nms.v1_15_R1.object.WrappedNBTImpl;
...
public class NMSHandlerImpl implements NMSHandler {
     ...
     */
    private <T extends Entity> T createCreature(EntityTypes<T> entityTypes, net.minecraft.server.v1_15_R1.World worldserver, NBTTagCompound nbttagcompound, IChatBaseComponent ichatbasecomponent, EntityHuman entityhuman, BlockPosition blockposition, EnumMobSpawn enummobspawn) {
        T newEntity;

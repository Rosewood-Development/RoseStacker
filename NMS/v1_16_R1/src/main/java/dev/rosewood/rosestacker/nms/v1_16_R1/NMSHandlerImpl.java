...
public class NMSHandlerImpl implements NMSHandler {
     ...
     */
    private <T extends Entity> T createCreature(EntityTypes<T> entityTypes, net.minecraft.server.v1_16_R1.World worldserver, NBTTagCompound nbttagcompound, IChatBaseComponent ichatbasecomponent, EntityHuman entityhuman, BlockPosition blockposition, EnumMobSpawn enummobspawn) {
        T newEntity;

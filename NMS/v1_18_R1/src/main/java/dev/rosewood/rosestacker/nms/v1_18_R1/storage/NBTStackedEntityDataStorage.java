...
public class NBTStackedEntityDataStorage implements StackedEntityDataStorage {
    ...
    private static final Field field_AbstractVillager_offsers = ReflectionUtils.getFieldByPositionAndType(net.minecraft.world.entity.npc.AbstractVillager.class, 0, MerchantOffers.class);
    ...
    public NBTStackedEntityDataStorage(LivingEntity livingEntity) {
        ...
        if (livingEntity instanceof AbstractVillager) {
            try {
                ...
                if (field_AbstractVillager_offsers.get(villager) == null)
                    field_AbstractVillager_offsers.set(villager, new MerchantOffers());

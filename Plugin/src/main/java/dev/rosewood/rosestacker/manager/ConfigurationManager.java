...
public class ConfigurationManager extends AbstractConfigurationManager {
    ...
    public enum Setting implements RoseSetting {
        ...
        ENTITY_ACCURATE_LOOT_OPTIONS_APPROXIMATION_ENABLED("global-entity-settings.accurate-loot-options.approximation-enabled", true, "Should loot be approximated to reduce lag for killing large stack sizes at once?"),
        ENTITY_ACCURATE_LOOT_OPTIONS_APPROXIMATION_THRESHOLD("global-entity-settings.accurate-loot-options.approximation-threshold", 2048, "The threshold at which loot drops will be approximated"),
        ENTITY_ACCURATE_LOOT_OPTIONS_APPROXIMATION_AMOUNT("global-entity-settings.accurate-loot-options.approximation-amount", 512, "The number of times the entity loot tables will be run"),

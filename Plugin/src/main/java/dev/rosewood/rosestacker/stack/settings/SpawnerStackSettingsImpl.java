...
public class SpawnerStackSettingsImpl extends BaseStackSettings implements SpawnerStackSettings {
    ...
    public SpawnerStackSettingsImpl(CommentedFileConfiguration settingsConfiguration, SpawnerType spawnerType) {
    ...
    protected void setDefaults() {
        ...
        this.spawnerType.get().ifPresent(entityType -> {
            ...
            EntityStackSettingsImpl entityStackSettings = RoseStacker.getInstance().getManager(StackSettingManager.class).getEntityStackSettings(entityType);

...
public class BlockStackSettingsImpl extends BaseStackSettings implements BlockStackSettings {
    ...
    public BlockStackSettingsImpl(CommentedFileConfiguration settingsConfiguration, Material material) {

...
public class StackedSpawnerImpl extends AbstractStack<SpawnerStackSettings> implements StackedSpawner {
    ...
    private SpawnerStackSettingsImpl stackSettings;

    public StackedSpawnerImpl(int size, Block spawner, boolean placedByPlayer) {
     ...
     */
    public StackedSpawnerImpl(int size, Location location) {
        this.size = size;
    ...
    @Override
    public SpawnerStackSettingsImpl getStackSettings() {

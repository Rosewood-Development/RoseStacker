...
public class StackChunkDataImpl implements StackChunkData {

    private final Map<Block, StackedSpawner> stackedSpawners;
    private final Map<Block, StackedBlock> stackedBlocks;

    public StackChunkDataImpl(Map<Block, StackedSpawner> stackedSpawners, Map<Block, StackedBlock> stackedBlocks) {

...
public class GiveCommand extends RoseCommand {
    ...
    public static class BlockGiveCommand extends RoseSubCommand {
        ...
        public void execute(@Inject CommandContext context, Player target, StackedBlockMaterial material, StackedBlockAmount stackSize, @Optional Integer amount) {
            ...
            String displayString = localeManager.getLocaleMessage("block-stack-display", StringPlaceholders.builder("amount", stackSize.get())
    ...
    public static class SpawnerGiveCommand extends RoseSubCommand {
        ...
        public void execute(@Inject CommandContext context, Player target, StackedSpawnerType entityType, StackedSpawnerAmount stackSize, @Optional Integer amount) {
            ...
            if (stackSize.get() == 1) {
                displayString = RoseStacker.getInstance().getManager(LocaleManager.class).getLocaleMessage("spawner-stack-display-single", StringPlaceholders.builder("amount", stackSize.get())
                        .addPlaceholder("name", stackSettings.getDisplayName()).build());
            } else {
                displayString = RoseStacker.getInstance().getManager(LocaleManager.class).getLocaleMessage("spawner-stack-display", StringPlaceholders.builder("amount", stackSize.get())
                        .addPlaceholder("name", stackSettings.getDisplayName()).build());
            }
    ...
    public static class EntityGiveCommand extends RoseSubCommand {
        ...
        public void execute(@Inject CommandContext context, Player target, StackedEntityType entityType, StackedEntityAmount stackSize, @Optional Integer amount) {
            ...
            String displayString = localeManager.getLocaleMessage("entity-stack-display-spawn-egg", StringPlaceholders.builder("amount", stackSize.get())
                    .addPlaceholder("name", stackSettings.getDisplayName()).build());

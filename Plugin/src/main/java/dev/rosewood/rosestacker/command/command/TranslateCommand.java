...
import dev.rosewood.rosestacker.command.argument.TranslationLocaleArgumentHandler;
...
public class TranslateCommand extends RoseCommand {
    ...
    @RoseExecutable
    public void execute(CommandContext context, TranslationLocaleArgumentHandler.TranslationLocale locale, @Optional GreedyString spawnerFormat) {

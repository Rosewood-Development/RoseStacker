...
public class StackedSpawner extends Stack {
    ...
    public StackedSpawner(int id, int size, CreatureSpawner spawner) {
        ...
        if (this.spawner != null) {
            this.stackSettings = SparkStacker.getInstance().getStackSettingManager().getSpawnerStackSettings(this.spawner);
    ...
    public void updateDisplay() {
        ...
        String displayString = SparkStacker.getInstance().getLocaleManager().getLocaleMessage("spawner-stack-display", StringPlaceholders.builder("amount", this.getStackSize())

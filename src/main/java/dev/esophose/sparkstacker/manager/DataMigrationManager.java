...
import dev.esophose.sparkstacker.database.DataMigration;
import dev.esophose.sparkstacker.database.DatabaseConnector;
import dev.esophose.sparkstacker.database.SQLiteConnector;
import dev.esophose.sparkstacker.database.migrations._1_InitialMigration;
...
public class DataMigrationManager extends Manager {
    ...
    public DataMigrationManager(SparkStacker sparkStacker) {
        super(sparkStacker);
    ...
    private String getMigrationsTableName() {
        return this.sparkStacker.getDataManager().getTablePrefix() + "migrations";
    }

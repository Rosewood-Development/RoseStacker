...
public class ConfigurationManager extends Manager {
    ...
    private static final String[] HEADER = new String[]{
            ...
            "    /   _____/__________ _______|  | __ /   _____//  |______    ____ |  | __ ___________ ",
            "    \\_____  \\\\____ \\__  \\\\_  __ \\  |/ / \\_____  \\\\   __\\__  \\ _/ ___\\|  |/ // __ \\_  __ \\",
            "    /        \\  |_> > __ \\|  | \\/    <  /        \\|  |  / __ \\\\  \\___|    <\\  ___/|  | \\/",
    ...
    public enum Setting {
        ...
        ENTITY_TRIGGER_DEATH_EVENT_FOR_ENTIRE_STACK_KILL("global-entity-settings.trigger-death-event-for-entire-stack-kill", false, "Should an entity death event be triggered for each mob in a stack?", "This should only be enabled if you have a custom drops plugin that relies on this event"),
        ...
        SPAWNER_SILK_TOUCH_REQUIRE_PERMISSION("global-spawner-settings.silk-touch-require-permission", false, "Should the permission sparkstacker.silktouch be required", "to be able to pick up spawners with silk touch?"),
        ...
        private void loadValue() {
            ...
            this.value = SparkStacker.getInstance().getConfigurationManager().getConfig().get(this.key);
        }
    }

    private CommentedFileConfiguration configuration;

    public ConfigurationManager(SparkStacker sparkStacker) {
        super(sparkStacker);
    }
